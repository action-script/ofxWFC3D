...
public:
    ofxWFC3D() {}
    void SetUp(std::string name, std::string subset_name, size_t max_x, size_t max_y, size_t max_z, bool periodic, std::string ground_name = "", std::string surround_name = "");
    bool Run(int seed);
